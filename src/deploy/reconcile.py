...
def owned_files(name: str, paths: Paths) -> list[Path]:
    ...
    """
    candidates = [paths.unit_file(name), paths.nginx_file(name)]
    return [p for p in candidates if p.exists()]


def plan_app_changes(name: str, desired: dict[Path, str], paths: Paths) -> list[Change]:
    ...
    """
    stale = [p for p in owned_files(name, paths) if p not in desired]
